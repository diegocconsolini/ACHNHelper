...
const FISH_DATA = [
  ...
  { id: 12, name: "Soft-shelled Turtle", location: "River", shadowSize: "Large", sellPrice: 3000, northMonths: [6,7,8,9], southMonths: [12,1,2,3], startHour: 0, endHour: 24, allDay: true, rarity: "Uncommon" },
  ...
  { id: 19, name: "Giant Snakehead", location: "Pond", shadowSize: "Large", sellPrice: 6000, northMonths: [7,8,9], southMonths: [1,2,3], startHour: 9, endHour: 16, allDay: false, rarity: "Uncommon" },
  ...
  { id: 77, name: "Football Fish", location: "Sea", shadowSize: "Large", sellPrice: 12000, northMonths: [1,2,3,4], southMonths: [7,8,9,10], startHour: 16, endHour: 9, allDay: false, rarity: "Rare" },
